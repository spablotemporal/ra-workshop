...
This workshop will cover the how to develop risk assessment and its implementation with R and the `quantrra` library. 

## Expected outcomes:

Participants will have a basic understanding on how to develop and implement risk assessment using R, and how to interpret the results of the analysis.
