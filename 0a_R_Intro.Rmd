...
For this workshop we will base our code in the [tidyverse styling](https://style.tidyverse.org/index.html). For a review on some introductory concepts to R and the tidyverse syntax, we included a file inside the `code/` directory of this posit cloud project. You can access it 
